    ...
    def __call__(self, model, val_loss):
        ...
        Args:
            model::[framework.module]
                The model currently being trained. Must implement .param() method
                which returns all model parameters and (if restore_best_weights = True),
                .load_params(params) method which restores them.
